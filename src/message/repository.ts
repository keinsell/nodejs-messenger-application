...
export abstract class MessageRepository implements Repository<Message> {
  abstract findAll(): Promise<Message[]>;
  abstract delete(id: string): Promise<void>;
  abstract save(message: Message): Promise<Message>;
  abstract findByThread(thread: Thread): Promise<Message[]>;
  abstract findById(messageId: any): Promise<Message | null>;
